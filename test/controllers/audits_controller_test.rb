...
class AuditsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create audit" do
    assert_difference("Audit.count") do
      post audits_url, params: { audit: { details: @audit.details, due_on: @audit.due_on, owner: @audit.owner, status: @audit.status, title: @audit.title } }
    end
  ...
  test "should update audit" do
    patch audit_url(@audit), params: { audit: { details: @audit.details, due_on: @audit.due_on, owner: @audit.owner, status: @audit.status, title: @audit.title } }
